...
@Titan.on_message(command("report") & filters.group)
async def report_watcher(c: Titan, m: Message):
...
@Titan.on_callback_query(filters.regex("^report_"))
async def report_buttons(c: Titan, q: CallbackQuery):

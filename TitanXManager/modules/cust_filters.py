...
from TitanXManager import DRAGONS, LOGGER, dispatcher
...
from TitanXManager.modules.helper_funcs.handlers import MessageHandlerChecker
from TitanXManager.modules.helper_funcs.misc import build_keyboard_parser
from TitanXManager.modules.helper_funcs.msg_types import get_filter_type
...
from TitanXManager.modules.sql import cust_filters_sql as sql
...
__help__ = """
Adds a filter to a chat. The bot will reply that with the filtered message whenever 'keyword'
is used. If you set a sticker in filter of any keyword then, the bot will reply with that sticker everytime when that 'keyboard' is used.

✧ /filters*:* List all active filters saved in the chat.
✧ /filter <keyword> <reply message>*:* To set a filter.
✧ /stop <keyword>*:* Stop that filter.
✧ /removeallfilters*:* Remove all chat filters at once.(Chat Owners Only)
"""

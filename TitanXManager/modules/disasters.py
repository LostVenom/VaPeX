...
from TitanXManager.modules.helper_funcs.extraction import extract_user
from TitanXManager.modules.log_channel import gloggable

ELEVATED_USERS_FILE = os.path.join(os.getcwd(), "TitanXManager/elevated_users.json")
...
*Broadcast: (Bot owner only)*
 ...
 ✧ /broadcastusers*:* Broadcasts to all users only.
 ✧ /broadcastgroups*:* Broadcasts to all groups only.

*Group Infos:*
 ✧ /groups*:* List the groups with Name, ID, Members count in a .txt file.
 ✧ /leave <ID>*:* Leave the group, ID must have hyphen.
 ✧ /stats*:* Shows overall bot stats.
 ✧ /getchats*:* Gets a list of group names the user has been seen in(Bot owner only).
 ✧ /ginfo <Username/link/ID>*:* Pulls info panel of the given group.
...
*Speedtest:*
 ✧ /speedtest*:* Runs a speedtest with 2 type of output as text or image output.

*Windows self hosted only:*
 ✧ /reboot*:* Restarts the bot.
 ✧ /gitpull*:* Pulls the repo and then restarts the bot
 
*Debugging and Shell:* 
 ✧ /debug <on/off>*:* Logs commands to updates.txt
 ✧ /logs*:* Run this in support group to get log.txt in pm.
 ✧ /sh*:* Runs shell command.
 ✧ /clearlocals*:* Cleans Locals.
 ✧ /dbcleanup*:* Removes deleted accs and groups from db.
 ✧ /py*:* Runs python code.
 
*Global Bans:*
 ❍ /gban <reason>*:* Globally Bans the user.
 ❍ /ungban*:* Globally Unban the user.
 ❍ /gbanlist*:* Gives a list of all Gbanned users.

For More Information Visit`` @{SUPPORT_CHAT}.
"""

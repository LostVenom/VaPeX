...
from TitanXManager import BOT_NAME
from TitanXManager import telethn as tbot
from TitanXManager.events import register
from TitanXManager.modules.sql.night_mode_sql import (
    add_nightmode,
    get_all_chat_id,
    is_nightmode_indb,
    rmnightmode,
...
__help__ = """
✧ /nightmode*:* Add nightmode to Group.
✧ /rmnight*:* Removes nightmode from Group.
*Note:* 
Groups with NightMode automatically gets closed at 12:00AM(IST) and opens automatically at 6:00AM(IST) to prevents group from night spams & raids..
"""

__mod_name__ = "◈ 𝐍ɪɢʜᴛ 𝐌ᴏᴅᴇ ◈"

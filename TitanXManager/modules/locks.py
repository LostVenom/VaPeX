...
import TitanXManager.modules.sql.locks_sql as sql
...
The locks module allows you to lock away some common items in the telegram world, the bot will automatically delete them!
 ...
 ✧ /lock <type>*:* Lock items of a certain type in that chat.
 ✧ /unlock <type>*:* Unlock items of a certain type in that chat.
 ✧ /locks*:* List all the locked items in that chat.
 ✧ /locktypes*:* Show the list of all items which can be locked.
"""

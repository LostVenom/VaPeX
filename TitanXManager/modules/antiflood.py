...
from TitanXManager.modules.sql import antiflood_sql as sql
...
__help__ = """
Antiflood allows you to take action on any user who sends more than X no. of messages in a Row.Exceeding the set flood limit bot will get in action & will result in restricting that user.

✧ /flood*:* Get the current antiflood settings of that group.
✧ /setflood <'no'/'off'>*:* Enables or disables flood control.
✧ /setfloodmode <ban/kick/mute/tban/tmute> <value>*:* Choose which action to perform when user exceeds flood limit.
 """

__mod_name__ = "◈ 𝐀ɴᴛɪғʟᴏᴏᴅ ◈"

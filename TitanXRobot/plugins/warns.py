...
from TitanXRobot import LOGGER, TIME_ZONE
from TitanXRobot.bot_class import Titan
from TitanXRobot.database.rules_db import Rules
...
from TitanXRobot.utils.custom_filters import admin_filter, command, restrict_filter
...
async def warn(c: Titan, m: Message):
...
@Titan.on_message(command("resetwarns") & restrict_filter)
async def reset_warn(c: Titan, m: Message):
...
@Titan.on_message(command("warns") & filters.group)
async def list_warns(c: Titan, m: Message):
...
async def remove_warn(c: Titan, m: Message):
...
@Titan.on_callback_query(filters.regex("^warn."))
async def remove_last_warn_btn(c: Titan, q: CallbackQuery):
...
@Titan.on_message(command(["warnings", "warnsettings"]) & admin_filter)
...
@Titan.on_message(command("warnmode") & admin_filter)
...
@Titan.on_message(command("warnlimit") & admin_filter)

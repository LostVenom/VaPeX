...
from TitanXRobot.utils.msg_types import Types, get_note_type
from TitanXRobot.utils.string import (build_keyboard,
...
@Titan.on_message(command("save") & admin_filter & ~filters.bot)
...
async def get_note_func(c: Titan, m: Message, note_name, priv_notes_status):
...
async def get_raw_note(c: Titan, m: Message, note: str):
...
@Titan.on_message(filters.regex(r"^#[^\s]+") & filters.group & ~filters.bot)
async def hash_get(c: Titan, m: Message):
...
@Titan.on_message(command("get") & filters.group & ~filters.bot)
async def get_note(c: Titan, m: Message):
...
@Titan.on_message(command(["privnotes", "privatenotes"]) & admin_filter & ~filters.bot)
...
@Titan.on_message(command("notes") & filters.group & ~filters.bot)
...
@Titan.on_message(command("clear") & admin_filter & ~filters.bot)
...
@Titan.on_message(command("clearall") & owner_filter & ~filters.bot)
...
@Titan.on_callback_query(filters.regex("^clear_notes$"))

...
def makepack_internal(
    ...
    try:
        ...
        if e.message == "Sticker set name is already occupied":
            ...
            msg.reply_text(
                "Sticker pack created Successfully. Get it [👻HERE👻](t.me/addstickers/%s)"
                % packname,
                parse_mode=ParseMode.MARKDOWN,
            )
        return
...
__help__ = """
 ...
 ✧ /stickerid*:* Reply to a sticker to get its Sticker Id..
 ✧ /getpng*:* Reply to a sticker to get its raw Png file.
"""

__mod_name__ = "◈ 𝐒ᴛɪᴄᴋᴇʀ ◈"

STICKERID_HANDLER = DisableAbleCommandHandler("stickerid", stickerid, run_async=True)
GETSTICKER_HANDLER = DisableAbleCommandHandler("getpng", getsticker, run_async=True)
KANG_HANDLER = DisableAbleCommandHandler("kang", kang, admin_ok=True, run_async=True)
STICKERS_HANDLER = DisableAbleCommandHandler("stiers", cb_sticker, run_async=True)

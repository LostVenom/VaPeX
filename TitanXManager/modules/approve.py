...
import TitanXManager.modules.sql.approve_sql as sql
...
✧ /approve*:* Approves a user.
   Locks, blacklists, and antiflood won't apply to them anymore.
✧ /unapprove*:* Unapproves a user.
   They will now be subject to locks, blacklists, and antiflood again.
✧ /approved*:* List all approved users.
✧ /unapproveall*:* Unapprove *ALL* users in current chat.
"""

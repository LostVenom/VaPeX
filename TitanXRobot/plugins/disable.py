...
from TitanXRobot import HELP_COMMANDS, LOGGER
from TitanXRobot.bot_class import Titan
from TitanXRobot.database.disable_db import Disabling
from TitanXRobot.utils.custom_filters import (admin_filter, can_change_filter,
                                         command, owner_filter)


@Titan.on_message(command("disable") & can_change_filter)
...
@Titan.on_message(command("disabledel") & can_change_filter)
...
@Titan.on_message(command("enable") & can_change_filter)
...
@Titan.on_message(command("disableable") & can_change_filter)
...
@Titan.on_message(command("disabled") & admin_filter)
...
@Titan.on_message(command("enableall") & owner_filter)
...
@Titan.on_callback_query(filters.regex("^enableallcmds$"))

...
from TitanXRobot.utils.custom_filters import command, owner_filter, restrict_filter
from TitanXRobot.utils.kbhelpers import ikb


@Titan.on_message(command("blacklist") & filters.group)
...
@Titan.on_message(command("addblacklist") & restrict_filter)
...
@Titan.on_callback_query(filters.regex("^rm_allblacklist$"))

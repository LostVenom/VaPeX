...
from TitanXRobot.utils.extras import MUTE_GIFS
...
@Titan.on_message(command("tmute") & restrict_filter)
async def tmute_usr(c: Titan, m: Message):
...
@Titan.on_message(command("dtmute") & restrict_filter)
async def dtmute_usr(c: Titan, m: Message):
    if len(m.text.split()) == 1 and not m.reply_to_message:
        await m.reply_text("I can't mute nothing!")
        return
...
@Titan.on_message(command("stmute") & restrict_filter)
async def stmute_usr(c: Titan, m: Message):
    if len(m.text.split()) == 1 and not m.reply_to_message:
        await m.reply_text("I can't mute nothing!")
        return
...
@Titan.on_message(command("mute") & restrict_filter)
async def mute_usr(c: Titan, m: Message):
    if len(m.text.split()) == 1 and not m.reply_to_message:
        await m.reply_text("I can't mute nothing!")
        return
...
@Titan.on_message(command("smute") & restrict_filter)
async def smute_usr(c: Titan, m: Message):
    if len(m.text.split()) == 1 and not m.reply_to_message:
        await m.reply_text("I can't mute nothing!")
        return
...
@Titan.on_message(command("dmute") & restrict_filter)
async def dmute_usr(c: Titan, m: Message):
    if len(m.text.split()) == 1 and not m.reply_to_message:
        await m.reply_text("I can't mute nothing!")
        return
    if not m.reply_to_message:
...
@Titan.on_message(command("unmute") & restrict_filter)
async def unmute_usr(c: Titan, m: Message):
    if len(m.text.split()) == 1 and not m.reply_to_message:
...
@Titan.on_callback_query(regex("^unmute_"))
async def unmutebutton(c: Titan, q: CallbackQuery):

...
__help__ = """
Keep your members in control with warnings; stop them getting out of control!

 ✧ /warns *:* Gets a user's number, and reason, of warns.
 ✧ /warnlist *:* Shows list of all current warning filters in the chat.
 ✧ /warnlist *:* Same as /warnlist.

*Admins Commands:*
 ✧ /warn *:* Warns a user. 
 ✧ /resetwarn *:* Reset warns of a user to 0.
 ✧ /addwarn <keyword> <message>*:* Set a warning filter on a certain keyboard. 
 ✧ /stopwarn <keyword>*:* Stop a warning filter with that keyboard.
 ✧ /nowarn <keyword>*:* Same as /stopwarn.
 ✧ /warnlimit <number>*:* Set the maximum warning limit.
 ✧ /warnend <on/yes/off/no>*:* If set to on, exceeding the warn limit will result in a ban.
"""

__mod_name__ = "◈ 𝐖ᴀʀɴs ◈"

WARN_HANDLER = CommandHandler(
    ["warn"], warn_user, filters=Filters.chat_type.groups, run_async=True
)

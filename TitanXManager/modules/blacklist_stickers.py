...
import TitanXManager.modules.sql.blsticker_sql as sql
...
__help__ = """
Block sticker is used to stop particular stickers from being send in group.If somebody tries to do so that message will be deleted immediately.

 ✧ /blockedstkr*:* See current blocklisted sticker
 
*Only admin:*
 ✧ /addblsticker *:* Add the replied sticker to the blocklist.
 ✧ /unblsticker *:* Remove the selected sticker blocklist.
 ✧ /blstickermode <ban/tban/mute/tmute>*:* To set which action to take on user if someone tries to share blocked sticker in the group.
"""

__mod_name__ = "◈ 𝐁ʟᴏᴄᴋ 𝐒𝐓 ◈"

BLACKLIST_STICKER_HANDLER = DisableAbleCommandHandler(
    "blockedstkr", blackliststicker, admin_ok=True, run_async=True
)
...
UNBLACKLIST_STICKER_HANDLER = CommandHandler(
    "unblsticker", unblackliststicker, run_async=True
)

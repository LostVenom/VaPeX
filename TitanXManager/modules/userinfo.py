...
import TitanXManager.modules.sql.userinfo_sql as sql
...
from TitanXManager.__main__ import STATS, TOKEN, USER_INFO
from TitanXManager.modules.disable import DisableAbleCommandHandler
from TitanXManager.modules.helper_funcs.chat_status import sudo_plus
...
from TitanXManager.modules.sql.users_sql import get_user_num_chats
            ...
            message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url="https://t.me/TitanXSupport"
                            ),
                            InlineKeyboardButton(
                                "ᴅɪꜱᴀꜱᴛᴇʀ", url="https://t.me/TitanXSupport"
                            ),
                        ],
                    ]
                ),

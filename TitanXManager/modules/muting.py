...
from TitanXManager import LOGGER, TIGERS, dispatcher
...
*ᴀᴅᴍɪɴs ᴏɴʟʏ:*
 ...
 ✧ /tmute x(m/h/d)*:* Mute a user for x time. Ex:- /mute 10m = mutes user for 10 minutes.
  Time Values - `m` = `minutes`, `h` = `hours`, `d` = `days`.
"""

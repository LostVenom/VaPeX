    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome yourself
                ...
                if not TitanXManager.ALLOW_CHATS:
...
__help__ = """
*Admins Commands:*
 ✧ /welcome*:* Shows current welcome message in that group.
 ✧ /welcome <on/off>*:* Enable/Disable group welcome messages.
 ✧ /setwelcome <text>*:* Set a new welcome message.If u want to add some media in welcome mesage set welcome in reply to that media.
 ✧ /goodbye*:* Shows current goodbye message in that group.
 ✧ /setgoodbye <text>*:* Set a new goodbye message.If u want to add some media in goodbye mesage set goodbye in reply to that media.
 ✧ /resetwelcome*:* Reset the welcome message to default.
 ✧ /resetgoodbye*:* Reset the goodbye message to default.
 ✧ /cleanwelcome <on/off>*:* If it sets to on bot will automatically delete last welcome message when a new user joins to avoid spamming in chat.
 ✧ /cleanservice <on/off>*:* Deletes Welcome/Goodbye service messages. 
*Welcome markdown:* 

...
import TitanXManager.modules.fun_strings as fun_strings
...
def slap(update: Update, context: CallbackContext):
    ...
    if user_id == bot.id:
        temp = random.choice(fun_strings.SLAP_TITAN_TEMPLATES)
...
__help__ = """
 ...
 ✧ /weebify <text>*:* Returns you a weebified text.
 ✧ /sanitize*:* Always use this before /pat.

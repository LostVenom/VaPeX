...
@Titan.on_message(command("purge") & admin_filter)
async def purge(c: Titan, m: Message):
...
@Titan.on_message(command("spurge") & admin_filter)
async def spurge(c: Titan, m: Message):
...
async def del_msg(c: Titan, m: Message):

...
from TitanXRobot import DB_NAME, DB_URI, LOGGER

try:
    TitanXRobot_db_client = MongoClient(DB_URI)
except PyMongoError as f:
    LOGGER.error(f"Error in Mongodb: {f}")
    exiter(1)
TitanXRobot_main_db = TitanXRobot_db_client[DB_NAME]
...
class MongoDB:
    ...
    def __init__(self, collection) -> None:
        self.collection = TitanXRobot_main_db[collection]
    ...
    @staticmethod
    def close():
        return TitanXRobot_db_client.close()

...
from TitanXRobot.utils.string import build_keyboard, parse_button


@Titan.on_message(command("pin") & admin_filter)
...
@Titan.on_message(command("unpin") & admin_filter)
async def unpin_message(c: Titan, m: Message):
    try:
        if m.reply_to_message:
...
@Titan.on_message(command("unpinall") & admin_filter)
...
@Titan.on_callback_query(regex("^unpin_all_in_this_chat$"))
async def unpinall_calllback(c: Titan, q: CallbackQuery):
...
@Titan.on_message(command("antichannelpin") & admin_filter)
...
@Titan.on_message(command("pinned") & admin_filter)
async def pinned_message(c: Titan, m: Message):
...
@Titan.on_message(command("cleanlinked") & admin_filter)
...
@Titan.on_message(command("permapin") & admin_filter)

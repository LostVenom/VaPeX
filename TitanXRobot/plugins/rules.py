...
@Titan.on_message(command("rules") & filters.group)
...
@Titan.on_message(command("setrules") & admin_filter)
...
@Titan.on_message(command("clearrules") & admin_filter)
...
@Titan.on_callback_query(filters.regex("^clear_rules$"))

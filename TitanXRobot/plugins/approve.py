...
@Titan.on_message(command("approve") & admin_filter)
async def approve_user(c: Titan, m: Message):
...
async def disapprove_user(c: Titan, m: Message):
    db = Approve(m.chat.id)
...
@Titan.on_message(command("approved") & admin_filter)
...
@Titan.on_message(command("approval") & filters.group)
async def check_approval(c: Titan, m: Message):
    db = Approve(m.chat.id)
...
@Titan.on_callback_query(filters.regex("^unapprove_all$"))

...
import TitanXManager.modules.sql.rules_sql as sql
...
from TitanXManager.modules.helper_funcs.string_handling import markdown_parser
...
__help__ = """
 ✧ /rules*:* Get the rules of that chat.
*Admins Commands:*
 ✧ /setrules <text>*:* Set the given text as rules of this chat.
 ✧ /clearrules*:* clear the rules of this chat.
"""

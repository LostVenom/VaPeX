...
from TitanXManager import TIME_API_KEY, dispatcher
...
__help__ = """
Shows Current Date & Time of given country.

 ✧ /time <country>*:* Gives information about date & time.

💡 Ex:- /time US *:* It will show current date and time of US.
"""

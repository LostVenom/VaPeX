...
from TitanXRobot import HELP_COMMANDS, LOGGER, SUPPORT_GROUP
from TitanXRobot.bot_class import Titan
from TitanXRobot.database.chats_db import Chats
from TitanXRobot.database.notes_db import Notes
...
from TitanXRobot.utils.msg_types import Types
...
async def get_private_note(c: Titan, m: Message, help_option: str):
...
async def get_help_msg(m: Message or CallbackQuery, help_option: str):
    ...
    if help_option in help_cmd_keys:
        ...
        if isinstance(m,CallbackQuery):
            ...
            mes = m
        help_msg = f"""
Hey **[{mes.from_user.first_name}](http://t.me/{mes.from_user.username})**!I am Titan✨.

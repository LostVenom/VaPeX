...
from TitanXManager.modules.helper_funcs.extraction import extract_user_and_text
from TitanXManager.modules.helper_funcs.string_handling import extract_time
from TitanXManager.modules.log_channel import gloggable, loggable
...
__help__ = """
 ✧ /kickme*:* Kicks the user who uses this command.
 ✧ /ban *:* To Ban a user. 
 ✧ /unban *:* To Unban a user.
 ✧ /sban *:* Silently Bans a user.
 ✧ /tban x(m/h/d)*:* To Ban a user Temporarily.Example - /ban 10m (`m` = `minutes`, `h` = `hours`, `d` = `days`).
 ✧ /kick *:* To kick any user out of the group.
"""

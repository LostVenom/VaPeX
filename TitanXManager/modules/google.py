...
__help__ = """
 ✧ /google <text>*:* Perform a google search for thr given text and displays the result found on google.
 ✧ /img <text>*:* Search Google for images and returns them\nFor greater no. of results specify lim, For eg: `/img hello lim=10`
 ✧ /app <appname>*:* Searches for an app in Play Store and gives its details.
